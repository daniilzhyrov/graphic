...
public class App extends JFrame{
    ...
    public void createSceneGraph(SimpleUniverse su) throws IOException {
        ...
        String name;
        BranchGroup bugBranchGroup = new BranchGroup();
        Background bugBackground = new Background(new Color3f(-1.0f,-1.0f,1.0f));

        ClassLoader classLoader = Thread.currentThread().getContextClassLoader();
        InputStream inputStream = classLoader.getResourceAsStream("models/ladybug.obj");
        Scene bugScene = f.load(new BufferedReader(new InputStreamReader(inputStream)));

        Hashtable roachNamedObjects = bugScene.getNamedObjects();
...
//        Background background = new Background(getTextureLoader("back.jpg").getImage());
...
//        bugBranchGroup.addChild(whiteRotXformGroup);
...
//        bugBackground.setApplicationBounds(bounds);
//        bugBranchGroup.addChild(bugBackground);
//
//        bugBranchGroup.compile();
//        su.addBranchGraph(bugBranchGroup);
    }
